...
export function JoinTeam() {
  ...
  const validateForm = () => {
    ...
    if (!cityCountry.trim())
      newErrors.cityCountry = "City / Country is required";
        ...
        <div className="lg:col-span-5 flex flex-col gap-6 h-full justify-between lg:py-6">
          <div>
            ...
            <p className="text-sm text-cream/50 mt-6 lg:mt-8 font-display lowercase">
              ...
              <Link
                href="/contact"
                className="cursor-pointer text-blob hover:underline font-bold transition-all duration-300 font-semibold">
                Contact us
              </Link>
            </p>
          </div>
          ...
          {formStatus === "success" ? (
            <div className="flex flex-col items-center justify-center text-center py-16 animate-in fade-in duration-500">
              ...
              <p className="mt-4 text-sm text-cream/70 max-w-md leading-relaxed">
                Thank you for applying. We are reviewing your profile and will
                get back to you shortly if your credentials match our current
                needs.
              </p>
              <button
                type="button"
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  />
                  {errors.fullName && (
                    <span className="text-[10px] text-red-400 font-display px-1">
                      {errors.fullName}
                    </span>
                  )}
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  <select
                    ...
                    <option value="" disabled className="bg-navy text-cream/30">
              ...
              {/* Textareas */}
              <div className="flex flex-col gap-1.5">
                <label className="font-display font-normal text-[12px] leading-[14px] text-cream/60 px-1">
                  Show us your work
                </label>
                <textarea
                  rows={2}
              ...
              <div className="flex flex-col gap-2">
                ...
                {fileError && (
                  <span className="text-[10px] text-red-400 font-display px-1 mt-0.5">
                    {fileError}
                  </span>
                )}
              </div>
