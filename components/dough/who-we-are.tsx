    ...
    <section
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 grid-flow-dense">
          ...
          <div className="md:col-span-2 p-8 md:p-12 rounded-3xl bg-[#122940]/5 border border-navy/10 flex flex-col justify-center min-h-[220px]">
          ...
          <div className="p-8 md:p-10 rounded-3xl bg-navy text-cream flex flex-col justify-between gap-10 md:row-span-2 border border-white/5 shadow-lg">
            <div>
          ...
          <div className="p-8 md:p-10 rounded-3xl bg-white border border-navy/10 flex flex-col justify-between min-h-[200px]">
          ...
          <div className="md:col-span-3 h-[300px] md:h-[450px] relative rounded-3xl overflow-hidden bg-navy border border-navy/10 shadow-md">
            <img
              src="/dough-hero.webp"
